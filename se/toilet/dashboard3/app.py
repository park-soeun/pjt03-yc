            ...
            ui.layout_column_wrap(
                ...
                ui.nav_panel("2. 여성·가족 인프라 분석",
                    ui.layout_column_wrap(
                        ...
                        # ✅ 6행: 지도 시각화 (1열)
                        ui.card(
                            ui.h4("⑧ 수유실 위치 및 CCTV 밀도 지도"),
                            output_widget("map_lactation_cctv"),
                            class_="shadow-md p-3 rounded-xl"
                        ),
                        ...
                        ui.card(
                            ...
                            ui.p("❗ CCTV 미설치 화장실이 21곳 존재합니다. 특히 B동, C면에 집중되어 있습니다."),
                            class_="bg-red-50 text-red-900 p-4 rounded-xl shadow-sm"
                        )
                    )
            )
